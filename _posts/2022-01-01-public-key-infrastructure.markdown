...
# WHAT IS PKI?
A [**_Public Key Infrastructure (PKI)_**](https://en.wikipedia.org/wiki/Public_key_infrastructure) is a collection of roles, policies, hardware, software, and procedures that are 
